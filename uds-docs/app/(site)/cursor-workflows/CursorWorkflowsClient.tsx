...
// (final callout). Tab strip uses SgPageTabs/SgPageTab/SgPageTabPanel from
// Chunk 04.
  ...
  return (
    <>
      {/* ================================================================
          ...
          ================================================================ */}
      <h1 className="sg-page-title">Cursor Workflows</h1>
      <p className="sg-page-desc">This site asks Cursor to do most of the design-system housekeeping &mdash; bumping versions, syncing Figma, writing changelogs, rebuilding release notes. You type a plain-English prompt; Cursor picks the right tool. This page is the map: what&apos;s in the toolbox, what each tool does, and which prompts trigger what.</p>

      {/* ================================================================
          QUICK START — "Say this, get that"
          ================================================================ */}
      <section className="sg-cw-section">
        <span className="sg-cw-eyebrow">
          <span className="material-symbols-outlined">bolt</span>
          Quick start
        </span>
        <h3 className="sg-subsection-title">Say this &mdash; get that</h3>
        <p className="sg-subsection-desc">The most common prompts and what they trigger. Type them in Cursor chat &mdash; you don&apos;t need to memorize skill names or workflows.</p>

        <div className="sg-cw-prompts">
          <article className="sg-cw-prompt">
      ...
      <section className="sg-cw-section">
        ...
        <h3 className="sg-subsection-title">What&apos;s in the toolbox</h3>
        <p className="sg-subsection-desc">Four kinds of guidance, ordered from always-on background discipline to called-on-demand specialists to enforced-by-CI safety nets. Each kind lives in its own folder and plays a different role.</p>

        <div className="sg-cw-concepts">
          <article className="sg-cw-concept" data-type="rule">
          ...
          <article className="sg-cw-concept" data-type="skill">
            ...
            <div className="sg-cw-concept-meta">
              ...
              <span className="sg-cw-concept-count">9</span>
            </div>
          </article>

          <article className="sg-cw-concept" data-type="subagent">
          ...
          <article className="sg-cw-concept" data-type="audit">
      ...
      <section className="sg-cw-section">
        ...
        <h3 className="sg-subsection-title">The whole toolchain</h3>
        <p className="sg-subsection-desc">Browse by category. Workflows show the end-to-end flows Cursor stitches together. The other tabs list every rule, skill, subagent, and audit individually.</p>
        ...
        >
          ...
          {/* ============================================================
              TAB PANEL: Workflows
              ============================================================ */}
          <SgPageTabPanel value="workflows">
            ...
            <article id="wf-release" className="sg-cw-workflow">
            ...
            <article id="wf-component-sync" className="sg-cw-workflow">
              <header className="sg-cw-workflow-header">
            ...
            <article id="wf-new-component" className="sg-cw-workflow">
              <header className="sg-cw-workflow-header">
            ...
            <article id="wf-component-edit" className="sg-cw-workflow">
              <header className="sg-cw-workflow-header">
          ...
          {/* ============================================================
              TAB PANEL: Subagents
              ============================================================ */}
          <SgPageTabPanel value="subagents">
          ...
          <SgPageTabPanel value="add">
            ...
            <div className="sg-cw-recipes">
              <article className="sg-cw-recipe">
