// Ported from docs/pages/design-process.html during Chunk 06b.
// Wrapped via dangerouslySetInnerHTML to preserve markup verbatim. Hash routes
// (#/foo) rewritten to plain Next.js paths (/foo). Page-specific styles
// (.sg-dp-*) live in styles/pages/legacy.css from Chunk 06a's bulk port.

export const metadata = { title: 'Design Process — UDS' };

const HTML = `<h1 class="sg-page-title">Design Process</h1>
        <p class="sg-page-desc">How a component moves from a first sketch to something developers can build. The page below proposes a process; the bottom half compares it to how big design systems handle the same problem.</p>
...
<!-- =======================================================
     DISCUSSION BANNER
     ======================================================= -->
<div class="sg-dp-discussion-banner">
...
<!-- =======================================================
     OVERVIEW
     ======================================================= -->
<p class="sg-page-desc">The stoplight tells you where each component is in the design process. Five colors, one for each stage. Red means just starting; green means ready for developers to build. The proposal below explains what each color means, what you'll see while you're there, and what to check off to move forward.</p>

<!-- =======================================================
     PART 1 — THE PROPOSED PROCESS
     ======================================================= -->
<div class="sg-dp-part-marker">Part 1 — The proposal</div>

<h3 class="sg-subsection-title">Two homes for a component</h3>
<p class="sg-subsection-desc">A component lives in two places during its life: Figma while you're designing it, then the docs site once it's far enough along to be written up. Developers come in after that, taking the finished design from the docs site and building it in Storybook. The stoplight is a designer's tool — it tracks how far along the design itself is, not the engineering work.</p>

<div class="sg-dp-universes">
  <div class="sg-dp-universe">
    <h4>Figma — where you're designing</h4>
    <p class="sg-dp-universe-body">Sketching, exploring, building out variants and states. Nothing on the docs site yet. The Figma page name carries a colored prefix that tells everyone how far along the work is.</p>
    <div class="sg-dp-universe-stages">
      <span class="sg-dp-pill"><span class="sg-dp-swatch sg-dp-swatch--red"></span>Red — Exploration</span>
      <span class="sg-dp-pill"><span class="sg-dp-swatch sg-dp-swatch--orange"></span>Orange — In Progress</span>
    </div>
  </div>
  <div class="sg-dp-universe">
    <h4>Docs site — where the finished design lives</h4>
    <p class="sg-dp-universe-body">The component has a page, a written spec, examples, and a status badge. Anyone in the company can see it and use it for product work. Green means the design is locked and developers can start building.</p>
    <div class="sg-dp-universe-stages">
      <span class="sg-dp-pill"><span class="sg-dp-swatch sg-dp-swatch--yellow"></span>Yellow — In Review</span>
      <span class="sg-dp-pill"><span class="sg-dp-swatch sg-dp-swatch--green"></span>Green — Production Ready</span>
      <span class="sg-dp-pill"><span class="sg-dp-swatch sg-dp-swatch--black"></span>Black — Deprecated</span>
    </div>
  </div>
</div>

<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">The five stages at a glance</h3>
<div class="sg-dp-flow">
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--red"></span>Red</span>
  <span class="sg-dp-flow-arrow">→</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--orange"></span>Orange</span>
  <span class="sg-dp-flow-arrow">→</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--yellow"></span>Yellow</span>
  <span class="sg-dp-flow-arrow">→</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--green"></span>Green</span>
  <span class="sg-dp-flow-arrow">⤳</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--black"></span>Black</span>
  <span class="sg-dp-flow-aside"><span class="material-symbols-outlined" style="font-size:14px;">code</span>Storybook (developers build here, after Green)</span>
  <span class="sg-dp-flow-caption">Forward is the typical path. Sunset to Black is dotted because not every component ends up there. Going backward (Yellow back to Orange, for example) is normal too — see "When things change" below.</span>
</div>

<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">The five stages, in detail</h3>
<p class="sg-subsection-desc">Each stage is a card with three sections: what the stage means, what you'll see while you're there, and what you need to check off before moving forward.</p>

<!-- Red — Exploration -->
<div class="sg-dp-stage-card">
  <div class="sg-dp-stage-card__header">
    <span class="sg-dp-stage-card__swatch sg-dp-swatch--red"></span>
    <h4 class="sg-dp-stage-card__title">Red — Exploration</h4>
    <div class="sg-dp-stage-card__meta">
      <span class="sg-dp-stage-card__meta-item"><strong>Lives in:</strong> Figma</span>
      <span class="sg-dp-stage-card__meta-item"><strong>Who works on it:</strong> Designer</span>
    </div>
  </div>
  <p class="sg-dp-stage-card__lead">You've just started thinking about a new component. You're sketching ideas in Figma — trying different shapes, sizes, and approaches to see what feels right.</p>
  <div class="sg-dp-checklist-heading">While you're here</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">To move to Orange</div>
  <ul class="sg-dp-checklist">
...
<div class="sg-dp-stage-card">
  <div class="sg-dp-stage-card__header">
    <span class="sg-dp-stage-card__swatch sg-dp-swatch--orange"></span>
    <h4 class="sg-dp-stage-card__title">Orange — In Progress</h4>
    <div class="sg-dp-stage-card__meta">
      <span class="sg-dp-stage-card__meta-item"><strong>Lives in:</strong> Figma</span>
      <span class="sg-dp-stage-card__meta-item"><strong>Who works on it:</strong> Designer</span>
    </div>
  </div>
  <p class="sg-dp-stage-card__lead">You've picked a direction and you're building it out properly — drawing all the variants (small/medium/large, primary/secondary, etc.) and all the states (hover, focused, disabled).</p>
  <div class="sg-dp-checklist-heading">While you're here</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">To move to Yellow</div>
  <ul class="sg-dp-checklist">
...
<div class="sg-dp-stage-card">
  ...
  <div class="sg-dp-checklist-heading">To move to Green</div>
  <ul class="sg-dp-checklist">
...
<div class="sg-dp-stage-card">
  <div class="sg-dp-stage-card__header">
    <span class="sg-dp-stage-card__swatch sg-dp-swatch--green"></span>
    <h4 class="sg-dp-stage-card__title">Green — Production Ready</h4>
    <div class="sg-dp-stage-card__meta">
      <span class="sg-dp-stage-card__meta-item"><strong>Lives in:</strong> Docs site</span>
      <span class="sg-dp-stage-card__meta-item"><strong>Who works on it:</strong> Designer</span>
    </div>
  </div>
  <p class="sg-dp-stage-card__lead">The design is locked. Marking it Green is how you tell developers "you can build this now — the spec won't keep changing on you." From here, developers pick the component up and build the production version in Storybook.</p>
  <div class="sg-dp-checklist-heading">While you're here</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">What happens after Green</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">If you decide to deprecate it (move to Black)</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">If you need to re-open for a major redesign (back to Yellow)</div>
  <ul class="sg-dp-checklist">
...
<div class="sg-dp-stage-card">
  <div class="sg-dp-stage-card__header">
    <span class="sg-dp-stage-card__swatch sg-dp-swatch--black"></span>
    <h4 class="sg-dp-stage-card__title">Black — Deprecated</h4>
    <div class="sg-dp-stage-card__meta">
      <span class="sg-dp-stage-card__meta-item"><strong>Lives in:</strong> Docs site</span>
      <span class="sg-dp-stage-card__meta-item"><strong>Who works on it:</strong> Designer</span>
    </div>
  </div>
  <p class="sg-dp-stage-card__lead">This component is being phased out. Projects that already use it can keep using it, but new work should reach for the replacement listed in the spec.</p>
  <div class="sg-dp-checklist-heading">While you're here</div>
  <ul class="sg-dp-checklist">
  ...
  <div class="sg-dp-checklist-heading">Day-to-day</div>
  <ul class="sg-dp-checklist">
...
<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">When things change</h3>
<p class="sg-subsection-desc">The real world isn't perfect. Designs evolve. Specs need tweaks. Components occasionally need to go backward before they can go forward. Three patterns cover almost every case.</p>

<div class="sg-dp-pattern">
...
<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">Where the status shows up</h3>
<ul class="sg-dp-loclist">
...
<!-- =======================================================
     ...
     ======================================================= -->
<div class="sg-dp-part-marker">Part 2 — How this compares to big design systems</div>

<h3 class="sg-subsection-title">Five things worth considering</h3>
<p class="sg-subsection-desc">When you look at how the biggest design systems work — Shopify's Polaris, IBM's Carbon, Salesforce's Lightning, Adobe's Spectrum, Google's Material — they all do a few things the proposal above doesn't. Here are five ideas worth weighing.</p>

<!-- Recommendation 1 -->
<div class="sg-dp-rec">
  <div class="sg-dp-rec__num">Recommendation 1 · Highest impact</div>
  <h4 class="sg-dp-rec__title">Add a "Beta" stage between approved and locked-forever</h4>
...
<!-- Recommendation 2 -->
<div class="sg-dp-rec">
  <div class="sg-dp-rec__num">Recommendation 2</div>
  <h4 class="sg-dp-rec__title">Drop the Red (Exploration) stage</h4>
...
<!-- Recommendation 3 -->
<div class="sg-dp-rec">
  <div class="sg-dp-rec__num">Recommendation 3</div>
  <h4 class="sg-dp-rec__title">Track that the Storybook build actually exists at Green</h4>
...
<!-- Recommendation 4 -->
<div class="sg-dp-rec">
  <div class="sg-dp-rec__num">Recommendation 4</div>
  <h4 class="sg-dp-rec__title">Require a written reason when a component goes backward</h4>
...
<!-- Recommendation 5 -->
<div class="sg-dp-rec">
  <div class="sg-dp-rec__num">Recommendation 5</div>
  <h4 class="sg-dp-rec__title">Add a "How this differs from most design systems" note</h4>
...
<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">If we adopted all five</h3>
<p class="sg-subsection-desc">The stoplight would look like this — four stages instead of five, with a Beta badge that can sit on top of Green:</p>

<div class="sg-dp-flow">
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--orange"></span>Orange — In Progress</span>
  <span class="sg-dp-flow-arrow">→</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--yellow"></span>Yellow — In Review</span>
  <span class="sg-dp-flow-arrow">→</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--green"></span>Green — Production
    <span style="display:inline-flex;align-items:center;gap:4px;padding:2px 6px;margin-left:6px;background:var(--uds-color-surface-info-subtle);color:var(--uds-color-text-info);border-radius:var(--uds-border-radius-container-full);font-size:var(--uds-font-size-xs);font-weight:var(--uds-font-weight-bold);">
      <span class="sg-dp-swatch sg-dp-swatch--beta" style="width:10px;height:10px;"></span>Beta
    </span>
  </span>
  <span class="sg-dp-flow-arrow">⤳</span>
  <span class="sg-dp-flow-node"><span class="sg-dp-swatch sg-dp-swatch--black"></span>Black — Deprecated</span>
  <span class="sg-dp-flow-caption">Early sketches stay private (no Red). Storybook is tracked on the Green checklist. Backward moves need a written reason.</span>
</div>

<p class="sg-subsection-desc" style="margin-top:var(--uds-space-200);">Concrete changes from the proposal in Part 1:</p>
<ul class="sg-dp-loclist">
...
<h3 class="sg-subsection-title" style="margin-top:var(--uds-space-400);">Open for discussion</h3>
<p class="sg-subsection-desc">This page captures both the proposal and the comparison side-by-side so they can be debated together. Resolved decisions will land either as edits to this page or as a real change to the live system. Until then, what's running today hasn't changed.</p>

<div class="sg-dp-xref">
