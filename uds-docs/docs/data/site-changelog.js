...
export const SITE_CHANGELOG = [
    ...
    },
    {
      ...
      changes: [
        ...
        { type: 'changed', text: 'SITE bumped 2026.05.22.4 &rarr; 2026.05.22.5. `app.js?v=` bumped because `docs/data/site-changelog.js` changed. `cursor-workflows.html` cache-busts via the runtime fetch helper. `site.css`, `uds.css`, `uds.js`, `demo-builder/index.js` unchanged.' }
      ]
    },
    {
      ...
      changes: [
        ...
        { type: 'changed', text: '`.cursor/TOOLCHAIN.md` regenerated. Counts unchanged.' },
        { type: 'changed', text: 'SITE bumped 2026.05.22.5 &rarr; 2026.05.22.6. `app.js?v=` bumped because `docs/data/site-changelog.js` changed. Other cache-bust params unchanged.' }
      ]
    }
];
