...
import { initTokenSearch } from './modules/token-search/index.js';
...
/* ========================================================================
     5. PLAYGROUND ENGINE
     ========================================================================
     Phase 15b: extracted to docs/modules/playground/index.js as a factory
     so we can pass deps (buildCopyButton, buildIconPicker, loadImplData,
     etc.) without also extracting every helper. The exported symbols
     (initPlayground, refreshPlaygrounds, loadPlaygroundConfig) keep the
     same shape callers expect.
     ======================================================================== */
// All deps below are function declarations hoisted to the top of this
// module scope (or imports), so passing direct references is safe even
// when this factory call appears textually before some of them.
...
const loadPlaygroundConfig = _playgroundEngine.loadPlaygroundConfig;
